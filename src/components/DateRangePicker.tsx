...
const DateRangePicker = React.memo(({ handleApplyDate, from, to }: any) => {
    ...
    useEffect(() => {
        ...
        if (from) setSelectedStartDate(formatDateString(from, "M/D/YYYY"));
        if (to) setSelectedEndDate(formatDateString(to, "M/D/YYYY"));
    ...
    const handleApply = () => {
        ...
        handleApplyDate(selectedStartDate, selectedEndDate);
        setIsOpen(false);
    };

    const handleCancel = () => {

        setSelectedStartDate(from ? formatDateString(from, "M/D/YYYY") : null);
        setSelectedEndDate(to ? formatDateString(to, "M/D/YYYY") : null);
        setIsOpen(false);
    };
                                ...
                                {isOpen && (
                                    ...
                                    >
                                        <div className="flex items-center justify-between px-5 text-black">
                                            ...
                                            <div id="currentMonth" className="text-lg font-medium" >
