...
export default function SenatorResultPage(props: any) {
                ...
                <div key={info} className="flex flex-row justify-between items-center">
                    <div className="flex flex-row items-center gap-2 m-1">
                        <div className="p-1 size-7 bg-slate-700 rounded-full">
                            <p className="text-sm font-medium text-center text-white">{`${data[info-1].totalization_order}`}</p>
                        </div>
                        <p className="text-sm font-medium">{data[info-1].candidate_name}</p>
                    </div>
                </div>
                : "",
        },
