...
export default function ValidatorFormPage(props: any) {
    ...
    return (
        <div className="">
            ...
            {loading && <Loader />}
            <span className="flex text-sm font-medium text-gray-500">User Management <ChevronRightIcon className="size-4 self-center" /> Validators <ChevronRightIcon className="size-4 self-center" /> <p className="text-black">Create Validator</p> </span>
