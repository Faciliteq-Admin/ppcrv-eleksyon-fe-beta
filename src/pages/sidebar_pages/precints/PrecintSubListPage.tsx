...
export default function PrecintSubListPage(props: any) {
    ...
    return (
        <div>
            ...
            {data && data.length > 0 && <TableCheckbox data={data} columns={tColumns} selectable={false} showActionButton={false} handleAdd={handleAddNew} />}
